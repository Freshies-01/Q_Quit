...
import com.lorence.myapp.service.MailService;
import com.lorence.myapp.service.UserService;
import com.lorence.myapp.service.dto.UserDTO;
import com.lorence.myapp.web.rest.errors.*;
import com.lorence.myapp.web.rest.vm.KeyAndPasswordVM;
import com.lorence.myapp.web.rest.vm.ManagedUserVM;
...
import com.lorence.myapp.service.dto.PasswordChangeDTO;
import java.util.*;
...
public class AccountResource {
     ...
     *                                   used
     */
    @PostMapping("/q_qregister")
    @Timed
    @ResponseStatus(HttpStatus.CREATED)
    public void registerQ_QAccount(@Valid @RequestBody ManagedUserVM managedUserVM) {
        if (!checkPasswordLength(managedUserVM.getPassword())) {
            throw new InvalidPasswordException();
        }
        userRepository.findOneByLogin(managedUserVM.getLogin().toLowerCase()).ifPresent(u -> {
