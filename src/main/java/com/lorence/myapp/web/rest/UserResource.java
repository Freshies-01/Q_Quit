...
import com.lorence.myapp.web.rest.errors.EmailAlreadyUsedException;
import com.lorence.myapp.web.rest.errors.LoginAlreadyUsedException;
    ...
    public String getCurrentUserLogin() {
        ...
        if (authentication != null) {
            if (authentication.getPrincipal() instanceof UserDTO)
             login = ((UserDTO) authentication.getPrincipal()).getLogin();
