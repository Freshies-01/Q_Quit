...
import { FunctionRepsDeletePopupComponent } from "app/entities/function-reps/function-reps-delete-dialog.component";
  ...
  resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot) {
    ...
    if (id) {
      return this.service
        .find(id)
        .pipe(
          map((functionReps: HttpResponse<FunctionReps>) => functionReps.body)
        );
    }
